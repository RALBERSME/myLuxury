...
function showEnglish() {
  frenchText.innerHTML = `
    <h2>Welcome!</h2><br><br>Welcome ladies and gentlemen! <br><br>I warmly welcome you to my
            ship. My name is Baron Raoul de Beaudean and I am the captain of
...
function showGerman() {
  frenchText.innerHTML = `
     <h2>Willkommen!</h2><br><br> Willkommen meine Damen und Herren!<br><br> Ich heiße Sie herzlich auf
            meinem Schiff willkommen. Mein Name ist Baron Raoul de Beaudean und
            ich bin der Kapitän dieses wunderschönen Luxusschiffs. Wir liegen
            gerade Hafen von New York, denn wir heute Abend in Richtung Frankreich verlassen werden. Kennen Sie die Stadt auf dem Foto? Das ist Le Havre (Frankreich); dort wurde dieses Schiff gebaut.<br><br> Bitte kommen
            Sie mit mir in den Salon. Bei einem prickelnden Glas Champagner
